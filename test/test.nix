...
let
  netns-isolation = builtins.getAttr scenario { default = true; nonetns = false; };
  testScriptFilename = builtins.getAttr scenario { default = ./scenarios/default.py; nonetns = ./scenarios/nonetns.py; };
in
